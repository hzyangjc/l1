    ...
    def update_actor(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            ...
            with Timer(name='update_policy', logger=None) as timer:
                # 从meta_info中获取lagrangian_multiplier
                lagrangian_multiplier = data.meta_info.get('lagrangian_multiplier', 0.0)
                metrics = self.actor.update_policy(data=data, lagrangian_multiplier=lagrangian_multiplier)
